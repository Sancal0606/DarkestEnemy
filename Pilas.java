...
public class Pilas {
    ...
    public Pilas(Game _game, int _posX, int _posY, int hab){
        game = _game;
        posX = _posX;
        posY = _posY;
    ...
    void checkCollision(){
        if(collisionPlayer()){
            ...
            if(game.bateria.countdown>=game.bateria.numeroInicial)
                game.bateria.countdown = game.bateria.numeroInicial;
            isActive=false;
            color=Color.green;
            game.p1.pila=true;
        }
