...
public class Player {
    ...
    public void keyPressed(KeyEvent e){
        ...
        if(e.getKeyCode()==KeyEvent.VK_ESCAPE&&Game.state==Game.State.Game){
            Game.state=Game.State.Pause;
        }
        else if(e.getKeyCode()==KeyEvent.VK_ESCAPE&&Game.state==Game.State.Pause){
        ...
        if(e.getKeyCode()==KeyEvent.VK_SHIFT&&pila&&canMove&& Game.state==Game.State.Game){
            lightOn=!lightOn;
        }
    ...
    public void paint(Graphics2D g){
        ...
        //g.fillRect(positionX-game.CamX-10, positionY-game.CamY+70, 75, 58);
        if(lightOn){
    ...
    public Rectangle getBoundsPlayer2() {
        return new Rectangle(positionX-game.CamX-10, positionY-game.CamY+70, 75, 58);
    }
     public Rectangle getBoundsBloque() {
        return new Rectangle(positionX-game.CamX+49, positionY-game.CamY+49,30,30);
    }
     
     public void getPos(){
         if(game.mapa.room1().intersects(getBoundsPlayer2())){
             room = 1;
         }
         if(game.mapa2.room2().intersects(getBoundsPlayer2())){
             room = 2;
         }
         if(game.mapa3.room3().intersects(getBoundsPlayer2())){
             room = 3;
         }
         if(game.mapa4.room4().intersects(getBoundsPlayer2())){
             room = 4;
         }
         if(game.mapa5.room5().intersects(getBoundsPlayer2())){
             room = 5;
         }
         if(game.mapa6.room6().intersects(getBoundsPlayer2())){
             room = 6;
         }if(game.mapa7.room7().intersects(getBoundsPlayer2())){
             room = 7;
         }if(game.mapa8.room8().intersects(getBoundsPlayer2())){
             room = 8;
         }if(game.mapa9.room9().intersects(getBoundsPlayer2())){
             room = 9;
         }
         if(game.mapa10.room5().intersects(getBoundsPlayer2())){
             room = 10;
         }
         if(game.mapa11.room5().intersects(getBoundsPlayer2())){
             room = 11;
         }
